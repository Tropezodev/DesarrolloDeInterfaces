...
from PySide6.QtWidgets import QLabel, QWidget, QPushButton, QVBoxLayout, QCheckBox, QTimeEdit, QHBoxLayout
from PySide6.QtCore import QTime, QTimer, Slot, QElapsedTimer, QSize, Qt, Signal
...
class Cronometro():
    ...
    def obtenerTiempo(self):
        return QTime(0, 0).addMSecs(self.__tiempo_transcurrido.elapsed() - self.__acumulador)
...
class CronometroUI(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.boton_inicio = QPushButton(QIcon(self.LISTA_ICONOS['play']), "", self)
        self.boton_inicio.setIconSize(QSize(50, 50))  
        #self.boton_inicio.setCheckable(True)  
        self.boton_pausa = QPushButton(QIcon(self.LISTA_ICONOS['pause']), "", self)
        ...
        self.editor_tiempo_aviso.timeChanged.connect(self.actualizar_tiempo_aviso)
    ...
    def actualizar_tiempo(self):
        ...
        self.etiqueta.repaint() # Para que actualize el valor antes de lanzar el aviso
